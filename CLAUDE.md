...
Canonical overlay: capabilities/overlays/lra-volume-v.md
...
Repository: `lra-volume-v`
Canonical repo overlay: `capabilities/overlays/lra-volume-v.md`
Canonical route resolver:
`python <governance-root>/scripts/govpy.py capabilities/resolve.py --repo lra-volume-v --task "<user task>" --root <repo-root>`
