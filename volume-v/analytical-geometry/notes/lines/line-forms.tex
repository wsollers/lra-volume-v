...
\begin{dependencies}
\begin{itemize}
  \item TODO: determine dependencies for \texttt{def:point-slope-form}.
\end{itemize}
\end{dependencies}
...
\begin{dependencies}
\begin{itemize}
  \item TODO: determine dependencies for \texttt{def:two-point-form}.
\end{itemize}
\end{dependencies}
...
\begin{dependencies}
\begin{itemize}
  \item TODO: determine dependencies for \texttt{def:general-linear-form}.
\end{itemize}
\end{dependencies}
...
\begin{dependencies}
\begin{itemize}
  \item TODO: determine dependencies for \texttt{def:vector-parametric-form}.
\end{itemize}
\end{dependencies}
...
\begin{dependencies}
\begin{itemize}
  \item TODO: determine dependencies for \texttt{def:intercept-form}.
\end{itemize}
\end{dependencies}
...
\begin{dependencies}
\begin{itemize}
  \item TODO: determine dependencies for \texttt{def:affine-parametric-line}.
\end{itemize}
\end{dependencies}
...
\begin{dependencies}
\begin{itemize}
  \item TODO: determine dependencies for \texttt{def:normal-form-line}.
\end{itemize}
\end{dependencies}
...
\begin{dependencies}
\begin{itemize}
  \item TODO: determine dependencies for \texttt{def:symmetric-form-line}.
\end{itemize}
\end{dependencies}
